...
@projects_bp.route('/mark_won/<proposal_number>', methods=['POST'])  # This one is correct
@login_required
...
@projects_bp.route('/mark_won_form/<proposal_number>')  # This one is correct
@login_required
...
@projects_bp.route('/project/<project_number>')  # Changed from '/view/<project_number>'
@login_required
...
@projects_bp.route('/project_info_form/<project_number>')  # This one is correct
@login_required
...
@projects_bp.route('/submit_project_info/<project_number>', methods=['POST'])  # This one is correct
@login_required
...
@projects_bp.route('/mark_project_complete/<project_number>')  # Changed from '/mark_complete/<project_number>'
@login_required
